...
user-invocable: true
argument-hint: "Describe the mobile task — e.g. 'add an offline banner to apps/scanner when network is unreachable' or 'wire a new volunteer-check-in screen in apps/mobile'"
---
