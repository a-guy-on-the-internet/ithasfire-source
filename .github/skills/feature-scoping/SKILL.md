...
Before writing anything, ask structured questions to fill gaps. Do not assume context.

**Required understanding (ask if missing):**
...
**Stop asking when you have enough to fill the spec template.** Two to three clarifying questions is usually sufficient. Don't interrogate the user into oblivion.
